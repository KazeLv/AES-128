...
static const byte_t INVERSE_S_BOX[16][16] = {0x52, 0x09, 0x6a, 0xd5, 0x30, 0x36, 0xa5, 0x38, 0xbf, 0x40, 0xa3, 0x9e, 0x81, 0xf3, 0xd7, 0xfb,
...
static const byte_t MIX_ARG[4][4] = {0x02, 0x03, 0x01, 0x01,
									 0x01, 0x02, 0x03, 0x01,
									 0x01, 0x01, 0x02, 0x03,
									 0x03, 0x01, 0x01, 0x02};

static const byte_t INVERSE_MIX_ARG[4][4] = {0x0e, 0x0b, 0x0d, 0x09,
											 0x09, 0x0e, 0x0b, 0x0d,
											 0x0d, 0x09, 0x0e, 0x0b,
											 0x0b, 0x0d, 0x09, 0x0e};
...
byte_t operator_multi(byte_t a, byte_t b){
	byte_t res = 0x00;
	//b参数按位从低到高计算、累加得到乘法结果
	for (int i = 0; i < 8;i++){		
		if ( (b & 0x01 ) != 0){		//若当前b最低位一位为1
			res ^= a;				//加上当前a值
		}
